...
prx.types.ios7_statusbar = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
        cR += '#'+_id+' .ios7-statusbar-inner { '+prx.componentsHelper.getFontCssFromFontFamily(item.textFont)+' '+prx.utils.getBgCss(item.backgroundColor)+'; color: '+prx.gradients.prxToCss(item.foregroundColor)+'; }';
...
prx.types.ios11_statusbar = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '#'+_id+' .ios11-statusbar-inner { '+prx.componentsHelper.getFontCssFromFontFamily(item.textFont)+' '+prx.utils.getBgCss(item.backgroundColor)+'; color: '+prx.gradients.prxToCss(item.foregroundColor)+'; }';
...
prx.types.ios7_button_bg = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		var text = '<div class="ios7-button-text liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont changeProperty-textSize"><span data-editableproperty="text">'+prx.componentsHelper.getProp(item.text,'text-textarea')+'</span></div>';
...
prx.types.ios7_picker = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="inner liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-textColor-color changeProperty-textColor changeProperty-textFont changeProperty-textSize changeProperty-textAlign" id="' + _id + '-inner">';
		...
		cR += '<div class="bar liveUpdate-textColor-border-color"></div>'; //wtf??
		cR += '</div>';
		cR += '</div>';
		cR += prx.items.getComponentAppendDivs(item, containerid, symbol);
		cR += '</div>';
...
prx.types.ios7_listcomplex = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '#' + _id + ' .ios7-list-badge { '+prx.componentsHelper.getProp(item.badgeFont,'font-family')+_badgeprops+'; font-size: '+prx.componentsHelper.getProp(item.badgeSize,'num-text-size')+'px; color: '+prx.componentsHelper.getProp(item.badgeColor,'color-text')+'; '+prx.utils.getBgCss(item.badgeBackgroundColor)+'; }';
		...
		$.each(item.listitems, function(i,elm){
			...
			cR += '<span data-editableproperty="text" data-dynamic-property-index="'+i+'">'+prx.componentsHelper.getProp(elm.text,'text-textarea')+'</span>';
			cR += '</div>';
			cR += '<div class="ios7-list-subtitle liveUpdate-subColor-color changeProperty-subColor changeProperty-subFont changeProperty-subSize">';
...
prx.types.ios7_list_header = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .ios7-list-header-inner { '+prx.utils.getBgCss(item.backgroundColor)+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; '+prx.css.flexJustifyContent(prx.componentsHelper.getProp(item.textAlign,'align'))+_props+' }';
...
prx.types.ios7_alert = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .ios7-alert-inner { '+prx.utils.getBgCss(item.backgroundColor)+'; border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
		...
		$.each(item.buttons, function(i,elm) {
			...
			cR += '<div id="'+_id+'-buttons-'+i+'" class="ios7-alert-button dynamic-property liveUpdate-borderColor-border-color liveUpdate-textColor-'+i+'-color changeProperty-borderColor changeProperty-textColor" data-dynamic-property-index="'+i+'" style="'+_props+' color: '+prx.componentsHelper.getProp(elm.textColor,'color-text')+';">';
			cR += '<span data-editableproperty="text" data-dynamic-property-index="'+i+'">' + prx.componentsHelper.getProp(elm.text,'text-textarea') + '</span>';
			cR += '</div>';
		});
		cR += '</div>';
...
prx.types.ios7_actionsheet = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<style>';
		cR += prx.items.getComponentBaseStyle(item, containerid, symbol);
		cR += '#'+_id+' .ios7-actionsheet-buttons { '+prx.utils.getBgCss(item.backgroundColor)+'; border-radius: '+prx.componentsHelper.getProp(item.borderRadius,'border-radius')+'; '+prx.componentsHelper.getProp(item.textFont,'font-family')+' color: '+prx.componentsHelper.getProp(item.textColor,'color-text')+'; font-size: '+prx.componentsHelper.getProp(item.textSize,'num-text-size')+'px; }';
		...
		cR += '<div class="ios7-actionsheet-buttons liveUpdate-backgroundColor-background-color liveUpdate-textColor-color liveUpdate-borderColor-border-color changeProperty-backgroundColor changeProperty-borderColor changeProperty-borderRadius changeProperty-borderWidth changeProperty-textSize changeProperty-textFont">'
		$.each(item.buttons, function(i,elm) {
		...
		if(prx.componentsHelper.getProp(item.detachlast,'boolean')) {
			...
			if(i>0) {
				...
				cR += '<div id="'+_id+'-buttons-'+i+'" class="ios7-actionsheet-button dynamic-property liveUpdate-borderColor-border-color liveUpdate-textColor-'+i+'-color changeProperty-borderColor" data-dynamic-property-index="'+i+'" style="'+_props+' color: '+prx.componentsHelper.getProp(item.buttons[i].textColor,'color-text')+';">';
...
prx.types.ios10_widget = {
	...
	,onDisplay: function(item,containerid,symbol) {
		...
		cR += '<div class="ios10-widget-title-bar-title liveUpdate-titleColor-color changeProperty-titleColor changeProperty-titleSize changeProperty-titleFont changeProperty-title">';
		...
		cR += '<div class="ios10-widget-title-bar-more liveUpdate-titleColor-color changeProperty-titleColor changeProperty-titleSize changeProperty-titleFont changeProperty-more">';
        ...
        cR += '<div class="ios10-widget-content liveUpdate-backgroundColor-background-color changeProperty-backgroundColor liveUpdate-textColor-color changeProperty-textColor changeProperty-textSize changeProperty-textFont changeProperty-textAlign changeProperty-text">';
		if( item.name == 'ios10_notification' ) {
